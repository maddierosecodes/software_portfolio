...
export default function ThreeLayerTitleText({
  ...
  return (
    ...
    >
      <h2 className="subtitle w-full" aria-label={topText}>
        {topText}
      </h2>
      <h1 className="title w-full xl:pl-3" aria-label={mainText}>
        {mainText}
      </h1>
      <h3 className="body-text w-full pb-5" aria-label={bottomText}>
        <i>{bottomText}</i>
      </h3>
    </div>
  );
